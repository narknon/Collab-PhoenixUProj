...
void UBlueprintGenerator::OnExistingPackageLoaded() {
	...
	if (ParentClass != NULL && Blueprint->ParentClass != ParentClass) {
		...
		UBlueprintGeneratorUtils::EnsureBlueprintUpToDate(Blueprint);
...
void UBlueprintGenerator::PostConstructOrUpdateAsset(UBlueprint* Blueprint) {
	...
	for (int32 i = 0; i < ImplementedInterfaces.Num(); i++) {
		...
		if (UBlueprintGeneratorUtils::ImplementNewInterface(Blueprint, InterfaceClass)) {
			MarkAssetChanged();
		}
	}
...
void UBlueprintGenerator::PopulateAssetWithData() {
	...
	const bool bChangedProperties = UBlueprintGeneratorUtils::CreateBlueprintVariablesForProperties(Blueprint, Properties, FunctionMap/*,*/
	...
	const bool bChangedFunctions = UBlueprintGeneratorUtils::CreateNewBlueprintFunctions(Blueprint, Functions,
...
bool UBlueprintGeneratorUtils::IsFunctionNameGenerated(const FString& FunctionName) {
...
bool UBlueprintGeneratorUtils::IsPropertyNameGenerated(const FString& PropertyName) {
	return PropertyName == TEXT("UberGraphFrame");
}

void UBlueprintGeneratorUtils::EnsureBlueprintUpToDate(UBlueprint* Blueprint) {
...
bool UBlueprintGeneratorUtils::ImplementNewInterface(UBlueprint* Blueprint, UClass* InterfaceClass) {
...
bool UBlueprintGeneratorUtils::CreateParentFunctionCall(UBlueprint* Blueprint, UFunction* Function, UK2Node* FunctionEntryOrEventNode, UK2Node_FunctionResult* FunctionReturnNode) {
...
UK2Node_Event* UBlueprintGeneratorUtils::CreateCustomEventNode(UBlueprint* Blueprint, const FName& EventName) {
...
UK2Node_FunctionResult* UBlueprintGeneratorUtils::CreateFunctionResultNode(const UK2Node_FunctionEntry* FunctionEntry, bool bAutoConnectNode) {
...
UK2Node_FunctionEntry* UBlueprintGeneratorUtils::CreateFunctionGraph(UBlueprint* Blueprint, const FName& FunctionName) {
...
UK2Node* UBlueprintGeneratorUtils::CreateFunctionOverride(UBlueprint* Blueprint, UFunction* Function, bool bOverrideAsEvent, bool bCreateParentCall) {
...
FName UBlueprintGeneratorUtils::GetFunctionNameForNode(UK2Node* Node) {
...
UFunction* UBlueprintGeneratorUtils::FindFunctionInParentClassOrInterfaces(UBlueprint* Blueprint, const FName& FunctionName) {
...
bool UBlueprintGeneratorUtils::CreateNewBlueprintFunctions(UBlueprint* Blueprint, const TArray<FDeserializedFunction>& Functions, /*const TFunctionRef<bool(const FDeserializedFunction& Function)>& FunctionFilter, */bool bCreateFunctionOverrides) {
...
bool UBlueprintGeneratorUtils::CreateBlueprintVariablesForProperties(UBlueprint* Blueprint, const TArray<FDeserializedProperty>& Properties,
...
bool UBlueprintGeneratorUtils::SetFunctionEntryParameters(UK2Node_EditablePinBase* FunctionEntry, const FDeserializedFunction& Function, bool bIsFunctionEntry) {
...
UEdGraph* UBlueprintGeneratorUtils::CreateNewBlueprintEventDispatcherSignatureGraph(UBlueprint* Blueprint, const FName& DispatcherName) {
...
FBPVariableDescription* UBlueprintGeneratorUtils::FindBlueprintVariableByName(UBlueprint* Blueprint, const FName& VariableName) {
...
void UBlueprintGeneratorUtils::ResetNodeDisabledState(UEdGraphNode* GraphNode) {
